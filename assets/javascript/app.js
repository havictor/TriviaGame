...
"answer4": ["Near the right edge of hte left lane", "use a higher gear", "right edge of the lane", "clutch pushing method", "vehicle track", "lean in the opposite direction of the turn", "to judge the speed of hte vehicle", "Visibility of oncoming vehicles", "Three quarters of total stopping power", "straighten, square, squeeze", "near intersections", "Only the front brake"],
"answerKey": [answer1, answer3, answer2, answer3, answer3, answer3, answer3, answer2, answer1, answer4, answer1, answer2]
}
...
function correctAnswer() {
    ...
    quiz.answerKey[progressCount] = true;
